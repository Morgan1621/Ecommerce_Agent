...
export default function Home() 
{
              ...
              >
               ...
               {/* 1. Botón Empezar */}
                <TouchableOpacity 
                  ...
                  activeOpacity={0.8}
                  onPress={() => router.push('/login')} // <-- Línea mágica que te redirige
                >
  ...
  {/* Enlace 1: Quiebes somos */}
  <View style={styles.footerSubLinksContainer}>
    <TouchableOpacity 
      activeOpacity={0.7} 
      onPress={() => scrollRef.current?.scrollTo({ y: 0, animated: true })}
      style={styles.footerSubLinkButton}
>
    <Text style={styles.footerSubLink}>Quiénes somos</Text>
  </TouchableOpacity>

    {/* Enlace 2: Política de privacidad */}
    <TouchableOpacity 
      activeOpacity={0.7} 
      onPress={() => scrollRef.current?.scrollTo({ y: 0, animated: true })}
      style={styles.footerSubLinkButton}
    >
      <Text style={styles.footerSubLink}>Política Privacidad</Text>
    </TouchableOpacity>

    {/* Enlace 3: Contáctenos */}
    <TouchableOpacity 
      activeOpacity={0.7} 
      onPress={() => scrollRef.current?.scrollTo({ y: 0, animated: true })}
      style={styles.footerSubLinkButton}
    >
      <Text style={styles.footerSubLink}>Contáctenos</Text>
    </TouchableOpacity>
  </View>
</View>
              {/* <View>
          ...
          <View style={styles.footerBottom}>
            <Text style={styles.footerCopy}>© 2026 Agente NexBot. Todos los derechos reservados.</Text>
          </View>
        </View>
...
footerLinksGroup: {
  // Maneja el grupo completo de enlaces
},
...
footerLinkHeader: {
  ...
  marginBottom: 12,  // mb-3 (aproximado)
},

footerSubLinksContainer: {
  gap: 8, // Esto imita perfectamente el 'space-y-2' de Tailwind (separa los links entre sí)
},

footerSubLinkButton: {
  paddingVertical: 6,         // Engrosamos un poco el botón para que sea más fácil hacer clic
  paddingHorizontal: 4,
  // @ts-ignore
  cursor: 'pointer',          // <-- OBLIGATORIO EN WEB: Cambia la flecha del mouse por la "manita" de link
},
...
footerSubLink: {
  fontSize: 14,             // text-sm
  color: 'rgba(255, 255, 255, 0.8)', // text-white/80 (blanco con 80% de opacidad)
